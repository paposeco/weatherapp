...
submitsearch.addEventListener("click", function (e) {
  ...
  if (form.checkValidity()) {
    console.log(typeof _script_js__WEBPACK_IMPORTED_MODULE_0__.default);
